...
const instance1 = new SubType(New sss')
instance1.colors.push('black')
console.log('instance1', instance1.name) // New sss'
console.log('instance1', instance1.colors) // ['red', 'blue', 'green', 'black']

const instance2 = new SubType(New sss1996')
console.log('instance2', instance2.name) // New sss1996'
...
const instance1 = new SubType(New sss', 18)
instance1.colors.push('black')
console.log('instance1', instance1.colors) // ['red', 'blue', 'green', 'black']
instance1.sayName() // New sss'
instance1.sayAge() // 18

const instance2 = new SubType(New sss1996', 27)
console.log('instance2', instance2.colors) // ['red', 'blue', 'green']
instance2.sayName() // New sss1996'
instance2.sayAge() // 27
```
...
instance1.name = New sss'
instance1.colors.push('black')

const instance2 = Object.create(person)
instance2.name = New sss1996'
...
修改 `instance1.name` 时，`instance2.name` 的值并未发生改变，并不是因为 `instance1` 和 `instance2` 有独立的 `name` 值，而是因为 `instance1.name = New sss'` 是给 `instance1` 添加了 `name` 值，并非修改了原型上的 `name` 值
